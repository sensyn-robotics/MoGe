...
| Open3D            | ICP point-cloud registration  | MIT                     |
...
| OpenIBL (default) | retrieval / loop closure      | MIT                     |
| MegaLoc (alt)     | retrieval / loop closure      | MIT                     |

Every dependency is MIT / BSD-3-Clause / Apache-2.0 — all compatible with MoGe's MIT license.
...
defaults (ALIKED + LightGlue + OpenIBL + Open3D) are all permissive.
"""
